...
*/
    public static void main(String[] args) {
        ...
        //gc.setOutputDir(projectPath + "/src/main/java");//文件输出位置
        gc.setOutputDir("E:\\zhuoyue\\microservice\\user.center\\user.service\\src\\main\\java\\com\\cm\\zhuoyue\\user");//文件输出位置
        gc.setAuthor("陈萌");//作者
        ...
        pc.setParent("com.cm.zhuoyue.user");
        ...
        */
        ...
        // templateConfig.setEntity("templates/entity2.java.ftl");
